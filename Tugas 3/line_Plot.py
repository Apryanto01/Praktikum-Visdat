...
st.title("Visualisasi Data Penjualan Produk Interaktif 🚀")
...
visualization_option = st.sidebar.selectbox(
    "Pilih Tipe Grafik",
    ("Customized Line Plot (Kreatif & Informatif)", 
    "Line Plot Sederhana", 
    "Subplot (Perbandingan A vs B)")
)

# --- Tampilkan Grafik Berdasarkan Pilihan ---
if visualization_option == "Customized Line Plot (Kreatif & Informatif)":
    st.header("1. Customized Line Plot Kreatif & Informatif")
...
st.subheader("Data Mentah Penjualan (Tabel Konteks)")
